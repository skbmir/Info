...
sudo apt install -y build-essential dkms libboost-all-dev libopenblas-dev \
	libeigen3-dev unrar unzip p7zip-full wget curl git pkg-config \
	libasio-dev libjpeg-dev libpng-dev liblapack-dev \
	...
	libgtk2.0-dev libgtk-3-dev libatlas-base-dev vlc transmission qt5-default \
